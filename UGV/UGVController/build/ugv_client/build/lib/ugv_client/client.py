...
class UGVClient(Node):
    def __init__(self):
        ...
        self.ugv_id = '67b3684324acb877aef49ba1'  # Default to 'UGV_1' if not set
        
        # Create a publisher for the /goal_pose topic
        self.goal_pose_publisher = self.create_publisher(PoseStamped, '/goal_pose', 10)
        
        # WebSocket URL (Replace with your cloud server's WebSocket address)
        self.websocket_url = "ws://localhost:10001"
        # API URL for registration (Replace with your server's address)
        self.registration_url = f"http://localhost:10001/api/ugv/{self.ugv_id}/registerSession"
